...
на сайте или перейти на GitHub'e в папку [docs/content](https://github.com/AngularjsRUS/angular-doc/tree/master/docs/content) выбрать раздел и файл, например
