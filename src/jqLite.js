 ...
 * поддерживается лишь часть jQuery API - методы, аргументы и работа со стилями.
 * 
 ...
 *
 * ## В дополнение к вышеуказанным, Angular предоставляет дополнительные методы для jQuery и jQuery lite:
 *
