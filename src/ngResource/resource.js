 ...
 *   - не GET экземпляр действия:  `экземпляр.$action([parameters], [success], [error])`
 *
 *
 ...
 * типом, в который содержит все не GET методы, доступные через методы с префиксом `$` . Это позволяет легко 
