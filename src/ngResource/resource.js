 ...
 *
 * @description
 * Фабрика, которая создает объект ресурса, позволяющий взаимодействовать с сервером в 
 * [RESTful](http://en.wikipedia.org/wiki/Representational_State_Transfer) стиле.
 * 
 * Возвращаемый объект ресурса имеет методы, предоставляющие высокоуровневый доступ, необходимый для 
